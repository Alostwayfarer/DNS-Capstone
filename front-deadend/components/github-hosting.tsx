...
function GitHubLinkPage({
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            setError(
                "An error occurred during the hosting process. Please check your GitHub link and try again."
            );
        } finally {
            setIsHosting(false);
        }
        ...
        <Card className="w-full max-w-2xl mx-auto mt-8 shadow-lg">
            <CardHeader className="bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-t-lg dark:from-blue-800 dark:to-purple-800">
                <CardTitle className="text-2xl font-bold">
                    Host Your GitHub Project
                </CardTitle>
                <CardDescription className="text-blue-100 dark:text-blue-200">
                    Enter your GitHub repository link to start hosting your
                    website.
                </CardDescription>
            </CardHeader>
...
function LogsAndSecurityPage({
    websiteLogs,
}: {
    websiteLogs: { id: number; message: string; timestamp: string }[];
}) {
    return (
        <Card className="w-full max-w-2xl mx-auto mt-8 shadow-lg">
            <CardHeader className="bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-t-lg dark:from-blue-800 dark:to-purple-800">
                ...
                <CardDescription className="text-blue-100 dark:text-blue-200">
                    View website activities and manage security settings.
                </CardDescription>
            </CardHeader>
            <CardContent className="p-6">
                <div className="bg-gray-50 p-4 rounded-lg mb-6 dark:bg-gray-800">
                    ...
                    {websiteLogs.length > 0 ? (
                        ...
                        <p className="text-gray-500 dark:text-gray-400">
                            No logs available. Host a website to see logs here.
                        </p>
                    )}
                </div>
