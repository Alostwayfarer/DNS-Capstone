          ...
          <form className="space-y-4">
            <div className="space-y-2">
              ...
              <Input 
                ...
                className={`bg-gray-700 border-gray-600 text-white placeholder-gray-400 ${!isValidLink && githubLink ? 'border-red-500' : ''}`}
              />
            ...
            <Button 
              ...
              disabled={isDeploying || !isValidLink || !githubLink || !deploymentType}
            >
              {isDeploying ? (
                <>
